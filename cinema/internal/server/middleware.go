...
func AuthMiddleware(authUC *usecases.AuthUseCase, next http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		user, err := authUC.ExecuteAuth(cookie.Value)
		if err != nil {
...
//func AuthMiddleware(repo ports.UserRepository, next http.HandlerFunc) http.HandlerFunc {
//	return func(w http.ResponseWriter, r *http.Request) {
//		cookie, err := r.Cookie("session_token")
//		if err != nil {
