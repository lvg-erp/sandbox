...
import (
	context "context"
	entity "psqlprof/server/internal/entity"
	reflect "reflect"
...
func (m *MockRepository) DeleteCommandById(ctx context.Context, commandId int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCommandById", ctx, commandId)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteCommandById indicates an expected call of DeleteCommandById.
func (mr *MockRepositoryMockRecorder) DeleteCommandById(ctx, commandId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCommandById", reflect.TypeOf((*MockRepository)(nil).DeleteCommandById), ctx, commandId)
}
