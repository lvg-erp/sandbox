...
//go:generate mockgen -destination=mocks/service.go -package=mock -source=commandService.go
...
type Repository interface {
	...
	DeleteCommandById(ctx context.Context, commandId int64) error
...
func NewService(repository Repository, scriptCache, execCache Cache) *Service {
