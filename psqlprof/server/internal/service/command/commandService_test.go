...
import (
	...
	mock "psqlprof/server/internal/service/command/mocks"
	"testing"
)
...
func TestService_CreateCommand(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			name: "test_2, error not exected",
			args: args{
				c: context.Background(), req: &entity.CreateCommandReq{
					Script:      "echo \"The current directory is:\" && pwd && echo \"The user logger in is:\" && whoami",
			...
			args: args{
				...
				req: &entity.CreateCommandReq{
					Script:      "echo\": \"echo \\\"Hello there\\\" && sleep 8 && echo \\\"Oops I feel asleep for a couple seconds\\\"",
					Description: "combined script witch sleeping",
				},
			},
			want: &entity.CreateCommandRes{
				ID:          "3",
	...
	tests := []struct {
	...
	}{
		{
			...
			prepare: func(args2 args, fields fields) {
				...
				fields.ScriptsCache.EXPECT().Set(int64(2), "echo: \"The current directory is:\" && pwd && echo \"The user logged in is:\" && whoami")
			},
		}, {
			name: "test_3, error not expected",
			args: args{
