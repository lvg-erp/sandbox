...
func (s *Server) IndexHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		start := time.Now()
		collector.TotalReq.WithLabelValues("200", r.URL.String(), r.Method).Inc()
		duration := time.Since(start)
		collector.ReqDuration.WithLabelValues("200", r.URL.String(), r.Method).Observe(float64(duration.Nanoseconds()))
		w.Write([]byte("HELLO!"))
...
func (s *Server) GetUserCommentHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != "GET" {
			...
			collector.TotalReq.WithLabelValues("405", r.URL.String(), r.Method).Inc()
			return
		}
		start := time.Now()
		collector.TotalReq.WithLabelValues("200", r.URL.String(), r.Method).Inc()
...
func notFound(w http.ResponseWriter, r *http.Request) {
	collector.TotalReq.WithLabelValues("404", r.URL.String(), r.Method).Inc()
